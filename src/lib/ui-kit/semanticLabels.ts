...
export const semanticLabels: Record<SemanticLabelId, SemanticLabelDefinition> = {
  ...
  product_studio: { family: "tag", variant: "neutral", label: "Продуктовая студия", interactive: false },
  ...
  premium: { family: "badge", variant: "premium", label: "Расширенный доступ", icon: "diamond", interactive: false },
  beta: { family: "badge", variant: "beta", label: "Бета", interactive: false },
