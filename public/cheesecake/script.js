...
2. Когда края держатся, а центр дрожит единым блоком, при необходимости включить гриль на 1–3 минуты только для цвета.
3. Охладить 1,5–2 часа на столе и минимум 6 часов в холодильнике.

Мой режим для Candy FCT615XL/1: Conventional = 220 °C, 20–21 минуты; затем Grill MAX = 2–3 минуты при закрытой двери.
